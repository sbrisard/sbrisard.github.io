...
\begin{equation}
\label{eq:5}
\vec n\cdot\tens{J}\cdot\vec n=\frac1d\vec n\cdot\left(\tens{\delta}\otimes\tens{\delta}\right)\cdot\vec n=\frac1d\vec n\otimes\vec n=\frac1d\tensii p.
\end{equation}
