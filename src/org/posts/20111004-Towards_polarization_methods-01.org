...
\begin{equation*}
\strain(\vec x)=\overline{\tens{\varepsilon}},\qquad\stress(\vec x)=\tens{C}_0:\overline{\tens{\varepsilon}}.
\end{equation*}
...
\begin{equation}
\label{eq:8}
\strain(\vec x)=\overline{\tens{\varepsilon}}-(\tens{\Gamma}_0\circledast\tens{\tau})(\vec x),
\end{equation}
...
\begin{equation}
\label{eq:9}
\strain(\vec x)+\left\{\tens{\Gamma}_0\circledast\left[\left(\tens{C}-\tens{C}_0\right):\strain\right]\right\}(\vec x)=\overline{\tens{\varepsilon}}.
\end{equation}
