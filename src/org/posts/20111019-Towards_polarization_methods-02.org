...
\begin{equation}
\label{eq:5}
\left(\tens{C}-\tens{C}_0\right)^{-1}:\tens{\tau}+\left(\tens{\Gamma}_0\circledast\tens{\tau}\right)=\Strain.
\end{equation}
...
\begin{equation}
\label{eq:6}
\volavg{\tens{\varpi}:\left(\tens{C}-\tens{C}_0\right)^{-1}:\tens{\tau}}+\volavg{\tens{\varpi}:\left(\tens{\Gamma}_0\circledast\tens{\tau}\right)}=\Strain:\volavg{\tens{\varpi}}.
\end{equation}
