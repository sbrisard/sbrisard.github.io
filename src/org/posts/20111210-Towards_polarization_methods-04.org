...
\begin{equation}
\label{eq:4}
\tens{\tau}=\left(\tens{C}-\tens{C}_0\right):\strain,
\end{equation}
...
\begin{equation}
\label{eq:5}
\mathcal H(\tens{\tau})=\frac12\Strain:\volavg{\left(\tens{C}-\tens{C}_0\right):\strain}=\frac12\Strain:\volavg{\tens{C}:\strain}-\frac12\Strain:\tens{C}_0:\volavg{\strain},
\end{equation}

where the second term accounts for the fact that the reference material is homogeneous. The above expression can be further simplified. Indeed, $\volavg\strain=\Strain$ (this is the very definition of the macroscopic strain $\Strain$). Furthermore, $\volavg{\tens{C}:\strain} = \volavg{\stress} = \Stress$, where $\Stress$ is the macroscopic stress in the composite. This macroscopic stress is in turn related to the macroscopic strain through the homogenized constitutive law, which reads in linear elasticity

\begin{equation}
\label{eq:6}
\Stress=\tens{C}^\eff:\Strain,
\end{equation}
...
\begin{equation}
\label{eq:7}
\mathcal H(\tens{\tau})=\frac12\Strain:\tens{C}^\eff:\Strain-\frac12\Strain:\tens{C}_0:\Strain.
\end{equation}
...
\begin{equation}
\label{eq:9}
\frac12\Strain:\tens{C}^\eff:\Strain\leq\frac12\Strain:\tens{C}_0:\Strain+\mathcal H(\tens{\varpi}).
\end{equation}
...
\begin{equation}
\label{eq:10}
\frac12\Strain:\tens{C}^\eff:\Strain\geq\frac12\Strain:\tens{C}_0:\Strain+\mathcal H(\tens{\varpi}).
\end{equation}
