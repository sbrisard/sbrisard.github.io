...
\begin{equation}
    \label{eq:4}
    \straincomp_{\alpha\beta}=\frac1{2\shearmod}\left(\sigma_{\alpha\beta}-\nu\sigma_{\gamma\gamma}\delta_{\alpha\beta}\right).
\end{equation}
