...
The fourth-rank spherical projection tensor $\tens{J}$ extracts the spherical part of any symmetric, second-rank tensor $\tensii u$

\begin{equation*}
\tens{J}:\tensii u=\frac1d\tr(\tensii u)\tens{\delta},
\end{equation*}
...
\begin{equation*}
\tens{K}:\tensii u=\tensii u-\frac1d\tr(\tensii u)\tens{\delta}=\tensii u-\tens{J}:\tensii u,
\end{equation*}
...
\begin{equation*}
\stress=d\kappa\tens{J}:\strain+2\mu\tens{K}:\strain=\stiffness:\strain,
\end{equation*}
...
\tens{J}:\tens{J}=\tens{J},\\
\tens{K}:\tens{K}=\tens{K},\\
\tens{K}:\tens{J}=\tens{J}:\tens{K}=\tensii0.
\end{gather*}
