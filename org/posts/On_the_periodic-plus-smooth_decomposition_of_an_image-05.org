...
#+TITLE: On the periodic-plus-smooth decomposition of an image, part 5: minimizing the energy, the crude way
#+DATE: [2018-01-30 Tue]
...
#+LINK: sb-blog-prev ./On_the_periodic-plus-smooth_decomposition_of_an_image-04.org
#+LINK: sb-blog-next ./On_the_periodic-plus-smooth_decomposition_of_an_image-06.org
...
[[sb-blog-part-02:][part 2]] of this series. More precisely, $u$ being a $m\times n$ image, we will
minimize the function $F(v, u)$ over the space of $m\times n$ images $v$. The
minimizer, $s$, is the smooth component of $u$, while its complement $p=u-s$ is
the periodic component of $u$. We showed in [[sb-blog-part-03:][part 3]] that $F$ was in fact a
quadratic form, and expressed the underlying linear operators, which were
subsequently implemented in [[sb-blog-prev:][part 4]]. It is recalled (see [[sb-blog-part-03:][part 3]]) that
