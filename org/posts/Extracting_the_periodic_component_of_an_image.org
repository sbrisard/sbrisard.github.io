...
center! Why would this be a problem? Well, many image analysis
...
issue in a dedicated series). This power spectrum is displayed below;
the bright cross at the center is the signature of the jumps across
