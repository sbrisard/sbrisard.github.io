...
The $Q_1$ operator was defined in the [[sb-blog-03:][previous post]] as the following sum:
...
The $Q$ operator was defined in the [[sb-blog-03:][previous post]] as the following sum:
...
where the energy $E$ was implemented in [[sb-blog-02:][part 2]] of this series.
