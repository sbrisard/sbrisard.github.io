...
We will also need the data from [[http://physics.nist.gov/PhysRefData/XrayMassCoef/tab1.html][table 1]].

#+BEGIN_EXAMPLE
scrapy shell "http://physics.nist.gov/PhysRefData/XrayMassCoef/tab1.html"
#+END_EXAMPLE
