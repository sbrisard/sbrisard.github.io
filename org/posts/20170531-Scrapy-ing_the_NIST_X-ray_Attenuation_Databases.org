...
It returns a =dict= which maps the element's atomic number Z to the
corresponding table (as a list of rows, each row being itself a
list). It can be run as follows
...
You can download the json files here: [[file:./20170531-Scrapy-ing_the_NIST_X-ray_Attenuation_Databases/table1.json][Table 1]] and [[file:./20170531-Scrapy-ing_the_NIST_X-ray_Attenuation_Databases/table3.json][Table 3]].
...
: [['00000E-03', '7.217E+00', '6.820E+00'], ['50000E-03', '2.148E+00', '1.752E+00'], ['00000E-03', '1.059E+00', '6.643E-01'], ['00000E-03', '5.612E-01', '1.693E-01'], ['00000E-03', '4.546E-01', '6.549E-02']]

#+BEGIN_SRC ipython :results output
  with h5py.File(os.path.join('.', ROOT, 'tables.hdf5'), 'w'):
