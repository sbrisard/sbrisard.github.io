# -*- coding: utf-8; -*-
#+TITLE: Orientation correlations among rice grains, part 4: defining the region of interest (ROI)
#+DATE: [2015-06-01 Mon]
...
#+NAME: fig:4
#+ATTR_HTML: :width 50%
file:./201506XX-Orientation_correlations_among_rice_grains-04/rice-bin_4x4x4-boundary-099.png
...
#+NAME: fig:4
#+ATTR_HTML: :width 50%
file:./201506XX-Orientation_correlations_among_rice_grains-04/rice-bin_4x4x4-roi_64x64+10+110-boundary-resized-099.png

* Analysis of the whole stack

We are now ready to carry out the above analysis on all 172 images of the stack. This is what the script below does ([[file:./201506XX-Orientation_correlations_among_rice_grains-04/find_boundary.py][download]]); in order to check that nothing went wrong, each image with overlaid boundary is saved for visual inspection.

#+INCLUDE: "./201506XX-Orientation_correlations_among_rice_grains-04/find_boundary.py" src python :eval never
