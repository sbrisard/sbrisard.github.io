...
The exact references to this paper can be found in my [[file:../pages/home.org::#BRIS2014][list of publications]]. The postprint is available on [[http://hal-enpc.archives-ouvertes.fr/hal-00922779][HAL ENPC]], and the published version is available [[http://dx.doi.org/10.1016/j.ijsolstr.2013.10.037][here]].
