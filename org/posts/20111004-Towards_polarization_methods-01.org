...
This equation was first introduced by [[file:../pages/references.org::#ZELL1973][Zeller and Dederichs (1973)]]. In the next instalments of this series, it will be more convenient to chose the polarization $\polarization$, rather that the strain $\strain$ as principal unknown. This leads to the equivalent integral equation
...
To sum up, we started with the set of partial differential equations \eqref{eq:1} -- \eqref{eq:4}, and ended up with one /single/, /equivalent/, integral equation. Discretization of the Lippmann-Schwinger equation \eqref{eq:9} has already been considered in the past. This leads to some well-known numerical schemes (Moulinec & Suquet, [[file:../pages/references.org::#MOUL1994][1994]], [[file:../pages/references.org::#MOUL1998][1998]]).
