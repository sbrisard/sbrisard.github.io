...
\end{equation}
and it is observed that $E_\mathrm s(s)=E_\mathrm s'(s)$ at the solution of the
...
From the left-hand side of Eq. \eqref{eq:6}, the linear operator
...
$Q_2=Q_2^\mathrm h+Q_2^\mathrm v$, we finally find that
