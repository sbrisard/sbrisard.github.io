...
focus here on the jumps across image boundaries. This leads to the following
expression
...
Now, smoothness is measured through the sum of squares of all jumps between
direct neighbors (indirect neighbors are excluded)
