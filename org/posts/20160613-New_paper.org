...
The exact references to this paper can be found in my [[file:../pages/about.org::#BRIS2016][list of publications]]. The submitted version (preprint) is available on [[https://hal-enpc.archives-ouvertes.fr/hal-01304603][HAL ENPC]], and the published version is available [[http://dx.doi.org/10.1002/nme.5263][here]].
