...
#+BEGIN_SRC ipython :results silent
  ...
  scipy.misc.imsave(DATA_DIR+'hut-648x364-fftshift.png', np.fft.fftshift(u))
#+END_SRC
...
#+BEGIN_SRC ipython :results silent
  ...
  scipy.misc.imsave(DATA_DIR+'hut-648x364-power_spectrum.png',
                    a.astype(np.uint8))
#+END_SRC
...
([[https://doi.org/10.1007/s10851-010-0227-1][Moisan, 2011]]). This led Moisan to introduce the /periodic-plus-smooth/
decomposition.
