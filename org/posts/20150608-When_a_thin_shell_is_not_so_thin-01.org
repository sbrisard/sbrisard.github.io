...
This is the first surprise in this series: the stress couples are /not/ null, and the stress resultant differ slightly from the well-known formula \(N=pR/2\) (see [[http://en.wikipedia.org/wiki/Pressure_vessel#Stress_in_thin-walled_pressure_vessels][Wikipedia]]).
