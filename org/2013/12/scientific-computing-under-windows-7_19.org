...
In the [[file:./scientific-computing-under-windows-7.org][previous installment]] of this series, we installed all prerequisites for the ITK library. We are now ready to install the library itself, using CMake.@@html:<!-- more -->@@
...
* History
  - <2013-12-19 Thu> Initial version.
  - <2013-12-26 Thu> Syntax highlighting.
