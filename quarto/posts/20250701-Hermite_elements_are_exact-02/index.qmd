...
of this statement, we will discuss ni the present post what
...
**strict equality** between two systems of loads. Indeed[^1]
$$
\begin{multline}
...
[^1]: There are quite a few “almost everywhere” missing in this
    statement…
...
polynomials (which is nothing but a clever decompsition of cubic
...
In the next instalment of this series, we will actually prove this
property.
